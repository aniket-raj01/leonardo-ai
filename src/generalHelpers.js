...
export const presetStyles = [
  ...
  { label: "Ray Traced", value: "RAYTRACED" },
  { label: "3D Render", value: "3D_RENDER" },
  { label: "Sketch B/W", value: "SKETCH_B/W" },
  { label: "Sketch Color", value: "SKETCH_COLOR" },
  { label: "Vibrant", value: "VIBRANT" },
];

export const combinedStylesWithModels = [
  {
    label: "Anime",
    value: "ANIME",
  ...
  },
  {
    ...
    modelName: "RPG v5",
    modelDescription:
      "Anashel returns with another great model, specializing in RPG characters of all kinds.",
  },
  {
    label: "Environment",
    value: "ENVIRONMENT",
    modelId: "7a65f0ab-64a7-4be2-bcf3-64a1cc56f627",
    modelName: "Isometric Scifi Buildings",
    modelDescription:
      "Great at creating scifi buildings of varying themes. Append the word isometric to your prompt to ensure an isometric view. '3d vray render' also helps steer the generation well.",
  },
  {
